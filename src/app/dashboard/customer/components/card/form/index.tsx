...
export function Form({ userId }: { userId: string }) {
    ...
    async function handleRegisterCustomer(data: FormData) { // faz uma requisição do tipo post passando as prpriedades
    ...
    return (
        <form className="flex flex-col mt-6" onSubmit={handleSubmit(handleRegisterCustomer)} >
            ...
            <section className="flex gap-2 my-2 flex-col sm:flex-row">
                ...
                <div className="flex-1">
                    ...
                    <Input
                        type="text"
                        name="phone"
                        placeholder="Exemplo (99) 999999999"
            ...
            <button
                type="submit"
                className="bg-blue-500 my-4 px-2 h-11 text-white font-bold">Cadastrar</button>
        </form>
    )
}